...
bm_device = device/moto/milestone2
...
PRODUCT_COPY_FILES += \
	...
	${bm_device}/bootmenu/modules/ntfs.ko:system/bootmenu/modules/ntfs.ko \
...
PRODUCT_COPY_FILES += \
	...
	$(bm_device)/bootmenu/binary/busybox:system/bootmenu/binary/busybox \
        ...
        $(bm_device)/bootmenu/binary/adbd:system/binary/adbd \
	$(bm_device)/bootmenu/binary/bootmenu:system/bin/bootmenu \
        $(bm_device)/bootmenu/2nd-boot/zImage:system/bootmenu/2nd-boot/zImage \
