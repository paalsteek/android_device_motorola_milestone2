...
static void Yuv420spToRgb565(unsigned char* rgb, unsigned char* yuv420sp, int width, int height, int stride)
{
    ...
    if (ret) {
        ...
        switch (format) {
            ...
            case Overlay::FORMAT_YUV420SP:
                Yuv420spToRgb565((unsigned char*)vaddr, (unsigned char*)frame, lcdev->previewWidth, lcdev->previewHeight, stride);
